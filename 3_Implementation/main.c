...
int main() {
  ...
  int userinputUSDtoEuro; 
   // User inputted for USD to EURO;
  int userinputUSDtoJPY;
   // User inputted for USD to JPY;
  int userinputUSDtoRUP;
   // User inputted for USD to RUP;
  int userinputOunce; 
   // User inputted for Ounce;
  int userinputGram; 
   // User inputted for Gram;
  ...
  float USDtoEURO ; 
   // varaible that stores the converted USD->EURO;
  float USDtoJPY; 
   // stores the converted USD->JPY;
  float USDtoRUP; 
   // stores the converted USD->RUP;
  float ounceToPounds; 
   // stores the converted Ounce->Pounds;
  float gramsToPounds; 
   // stores the vonerted Grams->Pounds;
  ...
  if(category == 'T'){
      ...
      if(currencyChoice == 1){
        ...
        printf("Please enter the USD amount: \n");
        scanf("%d",&userinputUSDtoRUP);
        USDtoRUP = userinputUSDtoRUP * 76.82;
        printf("RUP: %.2f",USDtoRUP);
      }
      else
